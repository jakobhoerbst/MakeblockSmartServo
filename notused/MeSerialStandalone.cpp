 ...
 * </pre>
 * @example MeSerialStandaloneReceiveTest.ino
 * @example MeSerialStandaloneTransmitTest.ino
 */
#include "MeSerialStandalone.h"
#include <stdio.h>
#include <stdarg.h>
 ...
 *   None
 */
MeSerialStandalone::MeSerialStandalone(void)
  _hard = true;
  _scratch = true;
  _polling = false;
}
 ...
 */
MeSerialStandalone::MeSerialStandalone(uint8_t port)
{
  _scratch = false;
  _hard = false;
  _polling = false;
 ...
 */
MeSerialStandalone::MeSerialStandalone(uint8_t receivePin, uint8_t transmitPin, bool inverse_logic)\
 ...
 *   None
 */
void MeSerialStandalone::setHardware(bool mode)
{
  _hard = mode;
}
 ...
 *   None
 */
void MeSerialStandalone::begin(long baudrate)
{
 ...
 *   None
 */
void MeSerialStandalone::end(void)
{
  if (_hard)
  {
#if defined(__AVR_ATmega32U4__)
 ...
 *   None
 */
size_t MeSerialStandalone::write(uint8_t byte)
{
  if (_hard)
  {
#if defined(__AVR_ATmega32U4__)
 ...
 *   None
 */
int16_t MeSerialStandalone::read(void)
{
  if (_polling)
  {
    int16_t temp = _byte;
 ...
 *   None
 */
int16_t MeSerialStandalone::available(void)
{
  if (_polling)
  {
    _byte = poll();
 ...
 *   None
 */
bool MeSerialStandalone::listen(void)
{
  if (_hard)
  {
    return (true);
 ...
 *   None
 */
bool MeSerialStandalone::isListening(void)
{
  if (_hard)
  {
    return (true);
 ...
 *   None
 */
int16_t MeSerialStandalone::poll(void)
{
  int16_t val = 0;
 ...
 *   None
 */
void MeSerialStandalone::sendString(char *str)
{
  while(*str)
  {
    write(*str++);
 ...
 *   None
 */
void MeSerialStandalone::printf(char *fmt,...)
{
  va_list ap;
  char string[128];
  va_start(ap,fmt);
...
boolean MeSerialStandalone::dataLineAvailable(void)
{
  if(available())
  {
    char c = read();
...
String MeSerialStandalone::readDataLine(void)
{
  if(bufferIndex>0)
  {
    lastLine = buffer;
...
float MeSerialStandalone::getValue(String key)
{
...
boolean MeSerialStandalone::equalString(String s1,String s2)
{
  return s1.equals(s2);
}

String MeSerialStandalone::concatenateWith(String s1,String s2)
{
  return s1+s2;
}

char MeSerialStandalone::letterOf(int i,String s)
{
  return s.charAt(i);
}

int MeSerialStandalone::stringLength(String s)
{
  return s.length();
}
